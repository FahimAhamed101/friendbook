...
import com.app.myfriend.live.activities.GoAudienceActivity;
...
public class AdapterLive extends RecyclerView.Adapter<AdapterLive.MyHolder>{
    ...
    int channelProfile;
    public static final String channelMessage = "com.app.myfriend.CHANNEL";
    public static final String profileMessage = "com.app.myfriend.PROFILE";
