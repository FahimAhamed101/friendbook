...
import com.app.myfriend.SharedMode;
...
import com.app.myfriend.admin.AdminActivity;
...
import com.app.myfriend.profile.EditProfileActivity;
import com.app.myfriend.reel.ReelActivity;
import com.app.myfriend.search.LocationActivity;
...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.editVideo).setOnClickListener(v -> startActivity(new Intent(MenuActivity.this, PagesActivity.class)));

        findViewById(R.id.search).setOnClickListener(v -> startActivity(new Intent(MenuActivity.this, AboutMeActivity.class)));
