package com.app.myfriend.podcast;
...
import com.app.myfriend.adapter.AdapterLiveChat;
import com.app.myfriend.live.activities.RtcBaseActivity;
import com.app.myfriend.live.stats.LocalStatsData;
import com.app.myfriend.live.stats.RemoteStatsData;
import com.app.myfriend.live.stats.StatsData;
import com.app.myfriend.live.ui.VideoGridContainer;
import com.app.myfriend.model.ModelLiveChat;
...
public class PodcastActivity extends RtcBaseActivity {
    ...
    private void initUI() {
         ...
         role = getIntent().getIntExtra(
                 com.app.myfriend.live.Constants.KEY_CLIENT_ROLE,
        ...
        rtcEngine().setBeautyEffectOptions(beautyBtn.isActivated(),
                com.app.myfriend.live.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initData() {
        mVideoDimension = com.app.myfriend.live.Constants.VIDEO_DIMENSIONS[
